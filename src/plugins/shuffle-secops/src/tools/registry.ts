...
export function createShuffleTools(clientFactory: () => ShuffleClientLike = memoizedShuffleClient()): ShufflePluginTool[] {
  return [
    new ShuffleTool(
...
function memoizedShuffleClient(): () => ShuffleClientLike {
  let client: ShuffleClientLike | undefined;
  return () => {
