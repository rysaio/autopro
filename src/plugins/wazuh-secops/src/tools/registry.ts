...
export function createWazuhTools(
  clientFactory: () => WazuhClientLike = memoizedWazuhClient(),
  indexerClientFactory: () => WazuhIndexerClientLike = memoizedWazuhIndexerClient()
): WazuhPluginTool[] {
  return [
    new WazuhTool(
...
function memoizedWazuhClient(): () => WazuhClientLike {
  let client: WazuhClientLike | undefined;
  return () => {
...
function memoizedWazuhIndexerClient(): () => WazuhIndexerClientLike {
  let client: WazuhIndexerClientLike | undefined;
  return () => {
...
function blockIpRequest(args: Record<string, unknown>, client: WazuhClientLike) {
