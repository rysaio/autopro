...
export function generateReport(request: GenerateReportRequest): Promise<GenerateReportResponse> {
  return postJson<GenerateReportResponse>("/api/reports/generate", request);
}

export function exportReport(request: ExportReportRequest): Promise<ExportReportResponse> {
  return postJson<ExportReportResponse>("/api/reports/export", request);
}
