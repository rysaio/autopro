...
- `2026-06-19` ADR: [Agent Control Boundary and Durable Session State](adr/2026-06-19-agent-control-boundary.md) — host-owned boundary and durable-session-state decision (engine choice: see the `2026-06-27` ADR).
- `2026-06-27` ADR: [Embedded PGlite Durable Sessions](adr/2026-06-27-embedded-pglite-durable-sessions.md)
