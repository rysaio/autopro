...
- `2026-06-19` ADR: [Agent Control Boundary and Durable Session State](adr/2026-06-19-agent-control-boundary.md) — durable-store portion superseded by the `2026-06-27` ADR.
