...
> **变更指引(2026-07-03):** 本设计中 Postgres durable-store 相关设计(如 5.5 节)已被嵌入式 PGlite 取代,见 [`../adr/2026-06-27-embedded-pglite-durable-sessions.md`](../adr/2026-06-27-embedded-pglite-durable-sessions.md)。本文件保留作历史设计记录。
